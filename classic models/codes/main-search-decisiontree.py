...
# 定义决策树分类器
dt_classifier = DecisionTreeClassifier(random_state=42,max_depth=14,criterion="gini",min_samples_leaf=14,min_samples_split=2,max_features="sqrt")
...
param_grid = {
    ...
    #  "min_samples_leaf": list(range(10,20,2)),
     "max_features": ["sqrt","auto","log2"]
    # "splitter": ["best"]
}

# 定义随机搜索对象
grid_search = GridSearchCV(dt_classifier , param_grid, cv=5,scoring='f1_weighted',verbose=2,n_jobs=-1)
