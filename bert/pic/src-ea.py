...
label_mapping = {
    "3-1.txt": "all-val acc",
    "3-2.txt": "conell-val acc",
    "3-3.txt": "misc-val acc",
    "3-4.txt": "texas-val acc",
    "3-5.txt": "washington-val acc",
    "3-6.txt": "wisconsin-val acc"
}

# 从多个文件中读取数据并绘制图像
file_paths = ["3-1.txt", "3-2.txt", "3-3.txt", "3-4.txt", "3-5.txt", "3-6.txt"]  # 文件路径列表
...
# 保存图像
save_path1 = "val_accuracy_1-10.png"
...
# 保存图像
save_path2 = "val_accuracy_5-10.png"
