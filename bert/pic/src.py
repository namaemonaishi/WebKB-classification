...
# 创建文件路径和标签的对应关系
label_mapping = {
    "4-1.txt": "all-val loss",
    "4-2.txt": "conell-val loss",
    "4-3.txt": "misc-val loss",
    "4-4.txt": "texas-val loss",
    "4-5.txt": "washington-val loss",
    "4-6.txt": "wisconsin-val loss"
}

# 从多个文件中读取数据并绘制图像
file_paths = ["4-1.txt", "4-2.txt", "4-3.txt", "4-4.txt", "4-5.txt", "4-6.txt"]  # 文件路径列表
